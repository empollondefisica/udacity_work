...
def compute_ranks(graph):
    ...
    for i in range(0, numloops):
        ...
        for page in graph:
            ...
            #Insert Code Here
            sum_link_ranks = 0
            for link_page in graph:
                if page in graph[link_page]:
                    sum_link_ranks = sum_link_ranks + (d * ranks[link_page] / len(graph[link_page]))
            
            newranks[page] = newrank + sum_link_ranks
        ranks = newranks
    return ranks
